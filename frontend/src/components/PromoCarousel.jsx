          ...
          {extended.map((group, idx) => {
            ...
            return (
              <div className="pc-slide" key={idx}>
                <div className={"pc-card" + ((isMinimal || forceCompact) ? " compact" : "")} style={{ background: bgStyle, minHeight: isNarrow ? 60 : 60 }}>
                  {(isMinimal || forceCompact) ? (
                    <div style={{ height:'100%', display:'grid', gridTemplateColumns:'minmax(100px, 1fr) 2fr minmax(88px, 14%) auto', alignItems:'center', gap: isNarrow ? 6 : 8, padding: isNarrow ? '5px 9px' : '5px 16px' }}>
                      {/* Title (left) */}
                    ...
                    <div className="pc-split" style={{ display:'grid', gridTemplateColumns: isNarrow ? '1fr' : '1.4fr 1fr', gap: isNarrow ? 9 : 11, alignItems:'stretch', width:'100%', height:'100%' }}>
                      {/* Left: Hero */}
                      <div className="pc-split-left" style={{ padding: isNarrow ? '9px 12px' : '10px 16px', display:'grid', gridTemplateRows:'auto 1fr auto', minHeight: isNarrow ? 135 : 120 }}>
                      ...
                      <div className="pc-split-right" style={ isNarrow
                        ? { display:'grid', gridTemplateColumns:'repeat(2, minmax(0, 1fr))', gap:8, padding:'6px 9px' }
